...
export function AppShell({
  ...
  /*
   * Still loading auth information.
   *
   * Do not show the app yet.
   */
  if (
    !hydrated ||
    !authInitialized
  ...
  /*
   * Auth check is finished and there is
   * no session.
   *
   * The effect above is already sending
   * the user to /auth.
   *
   * So render nothing for this tiny moment.
   */
  if (!session) {
    return null;
  }
