...
export default function ResetPasswordClient() {
  ...
  /*
   * Check whether the browser has a valid
  ...
  useEffect(() => {
    ...
    /*
     * Supabase may report the recovery session
     * through PASSWORD_RECOVERY after mount.
     */
    const {
      data: {
        subscription,
      ...
      async (values) => {
        ...
        try {
          ...
          try {
             ...
             * A cleanup failure should not make us
             * tell the user their password failed.
             */
            console.error(
  ...
  /*
   * Recovery session is still being checked.
   */
  if (checkingSession) {
    return (
      <div className="mesh-bg relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-8 sm:px-6">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute right-[-5%] top-[10%] size-[280px] rounded-full bg-primary/20 blur-[100px] sm:size-[400px]" />
          <div className="absolute bottom-[5%] left-[-5%] size-[240px] rounded-full bg-magenta/15 blur-[90px] sm:size-[320px]" />
        </div>

        <div className="glass-panel relative z-10 w-full max-w-md rounded-3xl p-6 text-center sm:p-8 md:p-10">
          <h1 className="font-heading text-xl font-bold text-on-surface sm:text-2xl">
    ...
    return (
      <div className="mesh-bg relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-8 sm:px-6">
        ...
        <div className="relative z-10 w-full max-w-md">
          <div className="glass-panel rounded-3xl p-6 text-center sm:p-8 md:p-10">
          ...
          >
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <button
                  type="button"
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-outline transition-colors hover:text-on-surface"
                  onClick={() =>
                    setShowPassword(
                      (value) => !value
                    )
